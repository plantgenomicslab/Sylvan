...
def main():
    ...
    print(f"filter_unstranded_transfrag: input={len(order)} "
          f"complete={complete_count} length_filter_pass={length_pass_count} "
          f"support_filter_pass={support_pass_count} final_output={kept}",
          file=sys.stderr)
