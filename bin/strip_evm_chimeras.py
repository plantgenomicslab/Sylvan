...
2026-07-30 fleet 실측(EVM 출력 기준):

    런별 최대 exon/mRNA   Ath 92 · Osa 79 · Mtr 90 · Ptr 107 · Sly 669
    런별 최대 단백질(aa)   Ath 5,394 · Osa 5,384 · Dca 7,748 · Mtr 18,012
                          Ptr 18,700 · Spe_A 18,242 · Sly 42,592

**이 기준에 걸리는 것은 Sly 뿐이다(57개). 다른 여섯 런은 0개**이므로, 전 런에
같은 규칙을 두어도 이미 채점된 런의 수치는 바뀌지 않는다 — 규칙은 공통이고
실제 영향은 한 런에만 있다.

참고로 aa 10,000~20,000 구간에는 Ptr 2 · Mtr 3 · Spe_A 2 개가 남는다. 이들은
PASA 를 통과했으므로 건드리지 않는다. 방법론에 잔존 키메라로 명시할 것.
